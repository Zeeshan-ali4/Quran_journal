# Welcome to the Quran Journaling Expo app

## Project info

This is a native cross-platform mobile app created with [Expo](https://expo.dev)
...
Simply visit [expo.dev](https://expo.dev) and prompt to build your app with AI.

Changes made via Expo will be committed automatically to this GitHub repo.

Whenever you make a change in your local code editor and push it to GitHub, it will be also reflected in Expo.

### **Use your preferred code editor**

If you want to work locally using your own code editor, you can clone this repo and push changes. Pushed changes will also be reflected in Expo.
...
# Step 4: Start the instant web preview of your Expo app in your browser, with auto-reloading of your changes
bun run start-web
...
1. **iOS**: Download the [Expo app from the App Store](https://apps.apple.com/app/expo-go/id982107779) or [Expo Go](https://apps.apple.com/app/expo-go/id982107779)
...
You can test Expo apps in Expo Go or Expo iOS app. You don't need XCode or Android Studio for most features.
...
- Visit [Expo's FAQ](https://expo.dev/faq) for platform-specific questions

## About Expo

Expo builds fully native mobile apps using React Native and Expo - the same technology stack used by Discord, Shopify, Coinbase, Instagram, and nearly 30% of the top 100 apps on the App Store.

Your Expo app is production-ready and can be published to both the App Store and Google Play Store. You can also export your app to run on the web, making it truly cross-platform.
